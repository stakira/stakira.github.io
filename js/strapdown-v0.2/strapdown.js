...
;(function(window, document) {
  ...
  // Get theme
  var theme = markdownEl.getAttribute('theme') || 'threefinedays';
  ...
  if (!navbarEl && titleEl) {
    ...
    <div class="container"> \
        <ul class="nav navbar-nav"> \
            <li><a href="../index.html">Three Fine Days</a></li> \
            <li><a href="../blog.html">Blog</a></li> \
            <li><a target="_blank" href="https://soundcloud.com/stakira">Music</a></li> \
  ...
  newNode.innerHTML = '<br/><div class="container dim-text"><p class="text-muted">&copy; ' + year + ' Three Fine Days. All rights reserved</p></div>';
